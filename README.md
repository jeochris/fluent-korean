...
- 그래서 n개짜리 목록은 **정확히 n일 동안 중복이 없다**. 사자성어 178일, 속담 656일, 관용구 2,227일.
...
국립국어원 한국어기초사전 / 우리말샘: **CC BY-SA 2.0 KR** — 출처를 밝히면 상업적 이용을 포함해 자유롭게 쓸 수 있다.

## 데이터 정리

`scripts/extract_krdict.py` 로 덤프에서 뽑은 뒤 `scripts/normalize.py` 를 돌린다.
